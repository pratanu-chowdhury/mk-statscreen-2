...
1. **Job description** — paste or upload the JD; StatScreen highlights signal terms.
2. **Predictors** — choose and configure the signals to read from each resume.
3. **Training data** — past candidates scored on those signals, with the hire outcome; weights refit live.
4. **Weights** — review the learned coefficients, override any by hand.
5. **Screen resumes** — upload the candidate pool, get a ranked, explainable shortlist.
...
Or skip setup entirely and try the hosted version: **[statscreen.lovable.app](https://statscreen.lovable.app)**
